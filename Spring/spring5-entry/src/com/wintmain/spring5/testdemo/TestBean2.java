...
public class TestBean2 {
    ...
    public void testCollection1(){
        ApplicationContext context = new ClassPathXmlApplicationContext("bean_collection.xml");
    ...
    public void testCollection2() {
        ApplicationContext context = new ClassPathXmlApplicationContext("bean_collection2.xml");
    ...
    public void testBean4(){
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("bean_postprocessor.xml");
        Orders orders = context.getBean("orders",Orders.class);
        System.out.println("第四步 获取创建bean实例对象");
        System.out.println(orders);
